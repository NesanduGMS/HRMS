    ...
    >
      ...
      <div className="absolute left-20 mt-10 text-white ml-40"> {/* Added mt-10 for top margin */}
        ...
        <div className="bg-[#001F3F] p-4 rounded flex flex-col items-center"> {/* Dark navy blue color */}
          <h1 className="text-4xl font-bold mb-1 text-yellow-300">Jupiter (PVT) Limited</h1> {/* Increased font size to 4xl */}
          <p className="text-sm mb-2 text-gray-200">Your trusted partner in excellence and innovation.</p> {/* Adjusted text color */}
        </div>
      </div>
