...
function ReportCard2() {
  ...
  return (
    <div className="max-w-sm bg-white rounded-lg shadow-md p-6 flex flex-col items-center">
      <h5 className="text-2xl font-bold text-center mb-2">Employee Report</h5>
      <p className="text-gray-700 text-center mb-4">
      Generate a report based on the employee records grouped by job title, department, and pay grade.
      </p>
      <button
