...
//   const [avlleave, setavlleave] = useState();
...
//   // Check if leaveData is not yet loaded
...
//             <p className="text-gray-600">Used: 3 days</p>
//             <p className="text-gray-600">Remaining: 7 days</p>
//           </div>
//         </div>
...
//             <p className="text-gray-600">Used: 2 days</p>
//             <p className="text-gray-600">Remaining: 3 days</p>
//           </div>
//         </div>
...
//             <p className="text-gray-600">Used: 5 days</p>
//             <p className="text-gray-600">Remaining: 10 days</p>
//           </div>
//         </div>
...
//             <p className="text-gray-600">Used: 4 weeks</p>
//             <p className="text-gray-600">Remaining: 8 weeks</p>
//           </div>
//         </div>
//       </div>
